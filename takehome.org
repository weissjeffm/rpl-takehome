...
| #'redplanetlabs.core/varargs?              |
| #'redplanetlabs.core/count-arity           |
| #'redplanetlabs.core/expand-arities        |
...
(deftest lexical-closure-test
  (is (= (closure) '(:yes :fnarg 4))))
#+end_src

*** Issues
**** TODO Have defstackfn return ToS only
...
**** TODO Define constants for all the languages' keywords
**** TODO Make 'break' compile out to nothing instead of no-op code
